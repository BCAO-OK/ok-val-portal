  ...
  switch (claims.v) {
    case 2:
      if (claims.o) {
        ...
        if ((_c = claims.o) == null ? void 0 : _c.rol) orgRole = `org:${(_d = claims.o) == null ? void 0 : _d.rol}`;
...
// node_modules/@clerk/backend/dist/chunk-7WXT7APB.mjs
...
var IdPOAuthAccessToken = class _IdPOAuthAccessToken {
  ...
  static fromJwtPayload(payload, clockSkewInMs = 5e3) {
    ...
    return new _IdPOAuthAccessToken(
      ...
      "oauth_token",
      payload.sub,
      oauthPayload.scp ?? ((_a = oauthPayload.scope) == null ? void 0 : _a.split(" ")) ?? [],
      false,
      null,
