...
var usePagesOrInfinite = (params) => {
  ...
  const count = (0, import_react6.useMemo)(() => {
    var _a;
    if (triggerInfinite) return ((_a = swrInfiniteData == null ? void 0 : swrInfiniteData[(swrInfiniteData == null ? void 0 : swrInfiniteData.length) - 1]) == null ? void 0 : _a.total_count) || 0;
...
function useOrganizationCreationDefaultsHook(params = {}) {
  ...
  const featureEnabled = ((_c = (_b = (_a = clerk.__unstable__environment) == null ? void 0 : _a.organizationSettings) == null ? void 0 : _b.organizationCreationDefaults) == null ? void 0 : _c.enabled) ?? false;
...
var useSession = () => {
  ...
  const session = useSessionContext();
  const clerk = useClerkInstanceContext();
  (_a = clerk.telemetry) == null ? void 0 : _a.record(eventMethodCalled(hookName$3));
...
function createBillingPaginatedHook({ hookName: hookName$4, resourceType, useFetcher, options }) {
  return function useBillingHook(params) {
    ...
    const user = useUserContext();
    const { organization } = useOrganizationContext();
    (_a = clerk.telemetry) == null ? void 0 : _a.record(eventMethodCalled(hookName$4));
...
var useLocalization = () => {
  ...
  let locale = "en";
  try {
    locale = ((_a = clerk.__internal_getOption("localization")) == null ? void 0 : _a.locale) || "en";
  } catch {
  }
...
var clerkJsScriptUrl = (opts) => {
  ...
  else if (domain && !isDevOrStagingUrl(((_a = parsePublishableKey(publishableKey)) == null ? void 0 : _a.frontendApi) || "")) scriptHost = addClerkPrefix(domain);
